...
{
    register8_t INTFLAGSA;      /* $0A PCMSK0 : Pin Change Mask Register */
    register8_t INTFLAGSB;      /* $10 PCMSK1 : Pin Change Mask Register */
...
==========================================================================
*/
// #define PORTA                       (*(PORT_t *)    0x00)
#define IOPORTA                     (*(PORT_t *)    0x00) /* Alias */
// #define PORTB                       (*(PORT_t *)    0x04)
#define IOPORTB                     (*(PORT_t *)    0x04) /* Alias */
#define PORTCTRL                    (*(PORTCTRL_t*) 0x16)
#define PCINT                       (*(PIINT_t *)   0x0F)
...
#define PCINT_INTCTRLA              _SFR_IO8(0x0F)  /* $10 PCMSK : Pin Change Mask Register */
#define PCINT_INTCTRLB              _SFR_IO8(0x10)  /* $10 PCMSK : Pin Change Mask Register */
...
/* PORTB - I/O Ports */
#define PORTA_IN                    _SFR_IO8(0x00)  /* PINA */
#define PORTA_DIR                   _SFR_IO8(0x01)  /* DDRA */
#define PORTA_OUT                   _SFR_IO8(0x02)  /* PORTA */
#define PORTA_PUE                   _SFR_IO8(0x03)  /* PUEA */
...
// #define TIM0_CAPT_vect        _VECTOR(4)    /* Timer/Counter0 Input Capture */
// #define TIM0_OVF_vect_num     5
// #define TIM0_OVF_vect         _VECTOR(5)    /* Timer/Counter0 Overflow */
