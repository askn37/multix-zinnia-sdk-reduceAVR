 ...
 * 
 * The TIM0 peripheral are also referred to as TCA0.
 * The TIM1 peripheral are also referred to as TCC0.
 * 
...
/* PCINT.INTCTRLC [PCMSK2] bit masks and bit positions */
#define PCINT_PORTC_0_bm        (1<<PCINT12)    /* PCINT PORTC 0 Enable bit mask. */
#define PCINT_PORTC_0_bp        PCINT12         /* PCINT PORTC 0 Enable bit position. */
#define PCINT_PORTC_1_bm        (1<<PCINT13)    /* PCINT PORTC 1 Enable bit mask. */
#define PCINT_PORTC_1_bp        PCINT13         /* PCINT PORTC 1 Enable bit position. */
#define PCINT_PORTC_2_bm        (1<<PCINT14)    /* PCINT PORTC 2 Enable bit mask. */
#define PCINT_PORTC_2_bp        PCINT14         /* PCINT PORTC 2 Enable bit position. */
#define PCINT_PORTC_3_bm        (1<<PCINT15)    /* PCINT PORTC 3 Enable bit mask. */
#define PCINT_PORTC_3_bp        PCINT15         /* PCINT PORTC 3 Enable bit position. */
#define PCINT_PORTC_4_bm        (1<<PCINT16)    /* PCINT PORTC 4 Enable bit mask. */
#define PCINT_PORTC_4_bp        PCINT16         /* PCINT PORTC 4 Enable bit position. */
#define PCINT_PORTC_5_bm        (1<<PCINT17)    /* PCINT PORTC 5 Enable bit mask. */
#define PCINT_PORTC_5_bp        PCINT17         /* PCINT PORTC 5 Enable bit position. */
...
#define PCINT_PORTC_bm          (1<<PCIF2)      /* PCINT PORTC bit mask. */
#define PCINT_PORTC_bp          PCIF2           /* PCINT PORTC bit position. */

/* PCINT.CTRLA [GIMSK] bit masks and bit positions */
/* PCINT_PORTA [PCIE0] is already defined. */
/* PCINT_PORTB [PCIE1] is already defined. */
/* PCINT_PORTB [PCIE2] is already defined. */


/* PORTCTRL.CTRLA [PORTCR] bit masks and bit positions */
#define PORTCTRL_DID1_gm        0xF0            /* Digital Input Disable 1 group mask. */
#define PORTCTRL_DID1_gp        ADC8D           /* Digital Input Disable 1 group position. */
...
#define PORTCTRL_BBMCE_bm       (1<<BBMC)       /* Break-Before-Make PORTC Enable bit mask. */
#define PORTCTRL_BBMCE_bp       BBMC            /* Break-Before-Make PORTC Enable bit position. */
#define PORTCTRL_AIN8_bm        (1<<ADC8D)      /* ADC input pin 8 Enable bit mask. */
#define PORTCTRL_AIN8_bp        ADC8D           /* ADC input pin 8 Enable bit position. */
#define PORTCTRL_AIN9_bm        (1<<ADC9D)      /* ADC input pin 9 Enable bit mask. */
#define PORTCTRL_AIN9_bp        ADC9D           /* ADC input pin 9 Enable bit position. */
#define PORTCTRL_AIN10_bm       (1<<ADC10D)     /* ADC input pin 10 Enable bit mask. */
#define PORTCTRL_AIN10_bp       ADC10D          /* ADC input pin 10 Enable bit position. */
#define PORTCTRL_AIN11_bm       (1<<ADC11D)     /* ADC input pin 11 Enable bit mask. */
#define PORTCTRL_AIN11_bp       ADC11D          /* ADC input pin 11 Enable bit position. */
...
#define SLPCTRL_TCC0_bm         (1<<PRTIM1)     /* Power reduction TCC0 bit mask. */
#define SLPCTRL_TCC0_bp         PRTIM1          /* Power reduction TCC0 bit position. */
...
#define TCA_SYNC_EN_bm          (1<<TSM)        /* Synchronization bit mask. */
#define TCA_SYNC_EN_bp          TSM             /* Synchronization bit position. */
...
/* TCC0.CTRLA [TCCR1A] bit masks and bit positions */
#define TCC_CLCKSEL_gm          (0x07<<CS10)    /* Clock Selectoer group mask. */
#define TCC_CLCKSEL_gp          CS10            /* Clock Selectoer group position. */
#define TCC_CLCKSEL_0_bm        (1<<CS10)       /* Clock Selectoer bit 0 mask. */
#define TCC_CLCKSEL_0_bp        CS10            /* Clock Selectoer bit 0 position. */
#define TCC_CLCKSEL_1_bm        (1<<CS11)       /* Clock Selectoer bit 1 mask. */
#define TCC_CLCKSEL_1_bp        CS11            /* Clock Selectoer bit 1 position. */
#define TCC_CLCKSEL_2_bm        (1<<CS12)       /* Clock Selectoer bit 2 mask. */
#define TCC_CLCKSEL_2_bp        CS12            /* Clock Selectoer bit 2 position. */
#define TCC_CTC_bm              (1<<CTC1)       /* Clear Timer Compare Match bit mask. */
#define TCC_CTC_bp              CTC1            /* Clear Timer Compare Match bit positon. */
#define TCC_EDGE_bm             (1<<ICES1)      /* Input Capture Edge bit mask. */
#define TCC_EDGE_bp             ICES1           /* Input Capture Edge bit positon. */
#define TCC_CNC_bm              (1<<ICNC1)      /* Input Capture Noise Canceler bit mask. */
#define TCC_CNC_bp              ICNC1           /* Input Capture Noise Canceler bit positon. */
#define TCC_CAPEN_bm            (1<<ICEN1)      /* Input Capture Enable bit mask. */
#define TCC_CAPEN_bp            ICEN1           /* Input Capture Enable bit positon. */
#define TCC_CNTHEN_bm           (1<<TCW1)       /* Counter 1 Width Enable bit mask. */
#define TCC_CNTHEN_bp           TCW1            /* Counter 1 Width Enable bit positon. */

/* TCC0.CTRLB [TCCR0B] bit masks and bit positions */
#define TCC_PSRESET_bm          (1<<PSR)        /* Prescaler Reset bit mask. */
#define TCC_PSRESET_bp          PSR             /* Prescaler Reset bit position. */
#define TCC_SYNC_EN_bm          (1<<TSM)        /* Synchronization bit mask. */
#define TCC_SYNC_EN_bp          TSM             /* Synchronization bit position. */
...
typedef enum ADC_MUXPOS_enum
{
    ...
    ADC_MUXPOS_AIN8_gc          = (8<<MUX0),    /* Multiplexer Select PB0 */
    ADC_MUXPOS_AIN9_gc          = (9<<MUX0),    /* Multiplexer Select PB1 */
    ADC_MUXPOS_AIN10_gc         = (10<<MUX0),   /* Multiplexer Select PB2 */
    ADC_MUXPOS_AIN11_gc         = (11<<MUX0),   /* Multiplexer Select PB3 */
    ADC_MUXPOS_GND_gc           = (12<<MUX0),   /* Multiplexer Select GND */
    ADC_MUXPOS_VBG_1V1_gc       = (13<<MUX0),   /* Multiplexer Select VBG 1.1V */
    ADC_MUXPOS_TEMP_gc          = (14<<MUX0)    /* Multiplexer Select Temperature */
} ADC_MUXPOS_t;
...
typedef struct PCINT_struct
{
    ...
    register8_t reserved[13];
    register8_t INTCTRLC;      /* $1A PCMSK2 : Pin Change Mask Register 2 */
} PCINT_t;
...
{
    register8_t DATA;           /* $1F RAMDR : RAM Data */
    register8_t ADDR;           /* $20 RAMAR : RAM Address */
} RAM_t;
...
/*
--------------------------------------------------------------------------
TCC - Timer/Counter controller
--------------------------------------------------------------------------
*/

/* 8-bit Timer */
typedef struct TCC_struct
{
    register8_t CTRLB;          /* $18 TCCR0B : Control Register B */
    ...
    register8_t INTFLAGS;       /* $25 TIFR   : Interrupt Flag Register */
    register8_t INTCTRL;        /* $26 TIMSK  : Interrupt Mask Register */
    register8_t CNTH;           /* $27 TCNT0  : Count high */
} TCC_t;

/* Wave Generation [TCCR1A] */
...
/* Clock Selection configurations */
typedef enum TCC_CLKSEL_enum
{
    TCC_CLKSEL_CLKSTOP_gc       = (0<<CS10),    /* No clock */
    TCC_CLKSEL_CLKDIV1_gc       = (1<<CS10),    /* CLK_PER (No Prescaling)  */
    TCC_CLKSEL_CLKDIV8_gc       = (2<<CS10),    /* CLK_PER/8 (From Prescaler) */
    TCC_CLKSEL_CLKDIV64_gc      = (3<<CS10),    /* CLK_PER/64 (From Prescaler) */
    TCC_CLKSEL_CLKDIV256_gc     = (4<<CS10),    /* CLK_PER/256 (From Prescaler) */
...
#define PCINT_INTCTRLC              _SFR_IO8(0x1A)  /* PCMSK2 : Pin Change Mask PORTB Register */
...
/* RAM - RAM Interface */
#define RAM_DATA                    _SFR_IO8(0x1F)  /* RAM Data */
#define RAM_ADDR                    _SFR_IO8(0x20)  /* RAM Address */
...
#define SLPCTRL_CTRLA               _SFR_IO8(0x3A)  /* MCUCR */
...
#define TCC0_INTCTRL                _SFR_IO8(0x26)  /* TIMSK */
#define TCC0_CNTH                   _SFR_IO8(0x27)  /* TCNT1H */
